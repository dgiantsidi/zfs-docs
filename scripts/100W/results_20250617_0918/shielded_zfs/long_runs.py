...
def main(args):
    ...
    cmd1 = "sudo docker run --name sysbench-client -it --rm --net host cloudsuite/data-serving-relational:client --warmup --tpcc --scale=100 --server-ip=10.7.0.4"
    cmd2 = "sudo docker run --name sysbench-client -it --rm --net host cloudsuite/data-serving-relational:client --run --tpcc  --scale=100 --server-ip=10.7.0.4   --time 150 --threads " + nthreads
    cmd3 = "sudo docker run --name sysbench-client -it --rm --net host cloudsuite/data-serving-relational:client --run --tpcc  --scale=100 --server-ip=10.7.0.4   --time 300 --threads " + nthreads
