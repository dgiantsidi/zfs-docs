...
| CVMs (w/o acc) |  **tput**=7284 op/s, **latency**=0.1372 ms | **tput**=7487.7 op/s, **latency**=0.133 ms | **tput**=4567.294 op/s, **latency**=0.218ms | **tput**=3291.44 op/s, **latency**=0.303 ms| **tput**= 3408.74 op/s, **latency**= 0.293 ms|
